...
public class App {
    ...
    private static void runEmpleadoExample() {
        EmpleadoContoller empt = new EmpleadoContoller();
        System.out.println();
        System.out.println("Datos de los empleados ");
        empt.addEmpleado(new Empleado(13541, "Pepito", "Developer"));
        empt.addEmpleado(new Empleado(1342, "Pablo", "Tester"));
        empt.addEmpleado(new Empleado(1346, "Juan", "Analyst"));
        empt.addEmpleado(new Empleado(13451, "Miguel", "Developer"));

        empt.imprimirEmpleados();
    }
